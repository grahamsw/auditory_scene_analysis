# homophonic-toggle-logic Specification

## Purpose
Supports switching between two independent sets of parameters for the homophonic demo to allow for rapid comparison of different perceptual states.
